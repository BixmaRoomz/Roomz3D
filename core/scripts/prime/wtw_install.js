...
WTWJS.prototype.openCart = function() {
	try {
		...
		WTW.openIFrame('https://3dnet.roomz.com/core/pages/cartroomz.php?serverinstanceid=' + btoa(dGet('wtw_serverinstanceid').value) + '&serverip=' + btoa(dGet('wtw_serverip').value) + '&domainname=' + btoa(dGet('wtw_domainname').value) + '&domainurl=' + btoa(dGet('wtw_domainurl').value) + '&websiteurl=' + btoa(dGet('wtw_websiteurl').value) + '&userid=' + btoa(dGet('wtw_userid').value) + '&useremail=' + btoa(dGet('wtw_useremail').value) + '&usertoken=' + btoa(dGet('wtw_usertoken').value) + '&selected=' + btoa(zselected), .8, .8, 'roomz Shopping Cart');
	} catch (ex) { 
