...
<?php 			if ($zresponse == '2') { 
				...
				<div class="wtw-loginbutton" onclick="WTW.resetPassword();"><img src="/content/system/images/wtwlogo.png" alt="Bixma" title="Bixma" class="wtw-image40"/><div style="margin-top:10px;">Save New Password</div></div>
<?php 		} else { ?>		
