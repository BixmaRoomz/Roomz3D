<?php
/* All code is Copyright 2013-2021 BixmaAB, Bixma - roomz, and the contributors */
/* Code is Patented  */
...
class wtw3dinternet {
	...
	public function initAdminOnlyHooks() {
		...
		try {
			...
			if ($wtwplugins->pagename == "admin.php") {
				...
				$wtwplugins->addAdminMenuItem('wtw_adminmediawtwdownloads', $wtwplugins->__('roomz Downloads'), -95, 'wtw_medialibrary', 3, 'wtw_viewwtwdownloads', '', array('admin','developer','architect','host'), "WTW.openFullPageForm('importpage','".$wtwplugins->__('communities')."');");
				...
				$wtwplugins->addAdminMenuItem('wtw_admin3dinternetavatars', $wtwplugins->__('roomz Logins and Avatars'), -70, 'wtw_3dinternetmenu', 1, 'wtw_3dinternetsettings', '', array('admin','developer'), "WTW.openFullPageForm('fullpage','".$wtwplugins->__('3D Internet')."','wtw_3dinternetloginspage');");
	...
	public function admin3dInternetLoginsForm() {
		...
		try {
			...
			$zformdata .= "		<div class=\"wtw-dashboardboxtitle\">3D Internet - roomz Logins and Avatars</div>\r\n";
			$zformdata .= "		<div class='wtw-roundedbox'><b>3D Internet</b> provides roomz Global Logins and Avatars use to any roomz site with these settings enabled. Use this panel to turn on or off features at a server level.<br /></div>\r\n";
			$zformdata .= "		<div class='wtw-clear'></div>\r\n";
			$zformdata .= "		<div class=\"wtw-dashboardbox\">\r\n";
			
			/* login settings - optional roomz global login and Local server Login */
			$zformdata .= "			<div class=\"wtw-controlpaneldiv\">\r\n";
			$zformdata .= "				<div class=\"wtw-controlpaneltitlediv\">Login / Avatar Settings</div>\r\n";
			$zformdata .= "				<label class=\"wtw-switch\"><input id=\"wtw3dinternet_enableglobal\" type=\"checkbox\" onclick=\"wtw3dinternet.changeSwitch(this);\"><span class=\"wtw-slider wtw-round\"></span></label><div id=\"wtw3dinternet_enableglobaltext\" class=\"wtw-disabledlabel\">Global Login/Avatars Disabled</div> <br />These are stored on the roomz Hub and work on all roomz 3D Websites.<br /><br />\r\n";
	...
	public function admin3dInternetTemplatesForm() {
		...
		try {
			...
			$zformdata .= "		<div class='wtw-roundedbox'><b>roomz Downloads</b> provide the ability to download 3D Webs (3D Community Scenes, 3D Buildings, 3D Things, 3D Avatars) and 3D Plugins. <b>Sharing</b> allows you to upload your 3D Webs as a template for others to download copies from the roomz Hub (https://3dnet.roomz.com). This does not affect your own local copy of the 3D Web. Use this panel to turn on or off features at a server level.<br /></div>\r\n";
			$zformdata .= "		<div class='wtw-clear'></div>\r\n";
			$zformdata .= "		<div class=\"wtw-dashboardbox\">\r\n";
			
			/* Templates settings - optional roomz Downloads and Sharing */
			$zformdata .= "			<div class=\"wtw-controlpaneldiv\">\r\n";
			
			$zformdata .= "				<div class=\"wtw-controlpaneltitlediv\">roomz Downloads Settings</div>\r\n";
			$zformdata .= "				<label class=\"wtw-switch\"><input id=\"wtw3dinternet_enabledownloads\" type=\"checkbox\" onclick=\"wtw3dinternet.changeSwitch(this);\"><span class=\"wtw-slider wtw-round\"></span></label><div id=\"wtw3dinternet_enabledownloadstext\" class=\"wtw-disabledlabel\">roomz Downloads Disabled</div> <br />The options to download 3D Communities, 3D Buildings, 3D Things, and 3D Avatars.<br /><br />\r\n";
	...
	public function admin3dInternetWTWDownloadsForm() {
		...
		try {
			...
			$zformdata .= "					<input id='wtw_bclosewebdownload' type='button' value='Close roomz Downloads' onclick='WTW.closeFullPageForm();' style='font-size:1.4em;border-radius:10px;cursor:pointer;' /><br /><br />\r\n";
			$zformdata .= "				</div>\r\n";
			$zformdata .= "			</div>\r\n";
			$zformdata .= "		</div><br />\r\n";
		} catch (Exception $e) {
	...
	public function addWebFromServerDiv($zwebtype) {
		...
		try {
			...
			$zmenu .= "						<div class='wtw-example'>(Example: d3.roomz.com)</div><br />\r\n";
				...
				if ($dbversion != $this->dbversion) {
					$wtwplugins->deltaCreateTable("
						CREATE TABLE `".WTW_3DINTERNET_PREFIX."useravatars` (
						  ...
						  `domain` varchar(256) DEFAULT 'd3.roomz.com',
