	...
	public function shareCommunityTemplate($zcommunityid, $zsharehash) {
		...
		try {
			if ($wtwhandlers->checkAdminAccess($zcommunityid, "", "")) {
				...
				$zfromurl = "https://3dnet.roomz.com/connect/share.php?communityid=".$zcommunityid."&userid=".$zuserid."&sharehash=".$zsharehash."&domainurl=".$wtwhandlers->domainurl;
	...
	public function shareBuildingTemplate($zbuildingid, $zsharehash) {
		...
		try {
			if ($wtwhandlers->checkAdminAccess("", $zbuildingid, "")) {
				...
				$zfromurl = "https://3dnet.roomz.com/connect/share.php?buildingid=".$zbuildingid."&userid=".$zuserid."&sharehash=".$zsharehash."&domainurl=".$wtwhandlers->domainurl;
	...
	public function shareThingTemplate($zthingid, $zsharehash) {
		...
		try {
			if ($wtwhandlers->checkAdminAccess("", "", $zthingid)) {
				...
				$zfromurl = "https://3dnet.roomz.com/connect/share.php?thingid=".$zthingid."&userid=".$zuserid."&sharehash=".$zsharehash."&domainurl=".$wtwhandlers->domainurl;
	...
	public function shareAvatarTemplate($zavatarid, $zsharehash) {
		...
		try {
			if ($wtwhandlers->hasPermission(array("admin","developer","architect","graphics artist","host"))) {
				...
				$zfromurl = "https://3dnet.roomz.com/connect/shareavatar.php?avatarid=".$zavatarid."&userid=".$zuserid."&sharehash=".$zsharehash."&domainurl=".$wtwhandlers->domainurl;
