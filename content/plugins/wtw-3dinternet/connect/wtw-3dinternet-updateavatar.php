...
try {
	...
	if (ini_get('allow_url_fopen') ) {
		if (!isset($zglobaluseravatarid) || empty($zglobaluseravatarid)) {
			...
			/* get global avatar */
			$avatarurl = "https://3dnet.roomz.com/connect/globalavatar.php?usertoken=".$zusertoken."&globaluseravatarid=".base64_encode($zglobaluseravatarid)."&serverinstanceid=".base64_encode($zserverinstanceid);
			$zavatardata = $wtwconnect->openFilefromURL($avatarurl);
		}
	}
