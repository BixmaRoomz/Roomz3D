...
WTW_3DINTERNET.prototype.communitySearch = async function(zsearch) {
	...
	try {
		...
		WTW.getAsyncJSON('https://3dnet.roomz.com/connect/sharesearch.php?search=' + zsearch + '&webtype=community', 
			function(zresponse) {
...
WTW_3DINTERNET.prototype.buildingSearch = async function(zsearch) {
	...
	try {
		...
		WTW.getAsyncJSON('https://3dnet.roomz.com/connect/sharesearch.php?search=' + zsearch + '&webtype=building&buildingtype=' + zbuildingtype, 
			function(zresponse) {
...
WTW_3DINTERNET.prototype.thingSearch = async function(zsearch) {
	...
	try {
		...
		WTW.hide('wtw_downloadcomplete');
		zsearch = WTW.encode(zsearch);
		WTW.getAsyncJSON('https://3dnet.roomz.com/connect/sharesearch.php?search=' + zsearch + '&webtype=thing', 
			function(zresponse) {
...
WTW_3DINTERNET.prototype.avatarSearch = async function(zsearch) {
	...
	try {
		...
		WTW.hide('wtw_downloadcomplete');
		zsearch = WTW.encode(zsearch);
		WTW.getAsyncJSON('https://3dnet.roomz.com/connect/sharesearch.php?search=' + zsearch + '&webtype=avatar', 
			function(zresponse) {
...
WTW_3DINTERNET.prototype.pluginSearch = async function(zsearch) {
	...
	try {
		...
		WTW.hide('wtw_downloadcomplete');
		zsearch = WTW.encode(zsearch);
		WTW.getAsyncJSON('https://3dnet.roomz.com/connect/sharesearch.php?search=' + zsearch + '&webtype=plugin', 
			function(zresponse) {
...
WTW_3DINTERNET.prototype.getDownloadsInfo = async function(zdownloads, zshow) {
	/* uses the local downloads to get the download info from 3dnet.roomz.com hub */
	try {
		...
		WTW.postAsyncJSON('https://3dnet.roomz.com/connect/downloadsinfo.php', zrequest, 
			function(zresponse) {
				zresponse = JSON.parse(zresponse);
				/* note serror would contain errors */
