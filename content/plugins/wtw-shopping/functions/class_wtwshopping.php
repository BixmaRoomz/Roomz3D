...
class wtwshopping {
	...
	public function listStoresPage() {
		...
		try {
			...
			$zformdata .= "			<div class='wtw-roundedbox'><b>3D Stores</b> are a way to connect your <b>WordPress WooCommerce</b> shopping cart and products into 3D Communities, 3D Buildings, and 3D Things. Allow or Deny permissions on this page allow your WordPress instance to view roomz settings (using the roomz Plugin).<br /><br />After a <b>3D Store</b> is added, open a 3D Community, 3D Building, or 3D Thing and select <b>Options and Settings -&gt; 3D Store Settings</b> to connect it to a particular 3D Store and Products.<br /></div>\r\n";
			$zformdata .= "			<div class='wtw-clear'></div>\r\n";
